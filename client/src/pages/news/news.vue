...
export default {
  ...
  data() {
    return {
      ...
      carousel: [
        {
          cover: 'http://qfjny782p.hn-bkt.clouddn.com/qiushibk/demo/banner1.jpg',
        },
        {
          cover: 'http://qfjny782p.hn-bkt.clouddn.com/qiushibk/demo/banner2.jpg',
        },
        {
          cover: 'http://qfjny782p.hn-bkt.clouddn.com/qiushibk/demo/banner3.jpg',
        },
      ],
      topicList: [
        {
